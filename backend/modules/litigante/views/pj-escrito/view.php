        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            <p>
                ...
                <?= Html::a('<i class="fa fa-minus"></i> Eliminar', ['delete', 'id' => $model->id], [
                    ...
                    'data' => [
                        'confirm' => '¿Esta seguro que desea eliminar este escrito?',
                        'method' => 'post',
                    ],
                ]) ?>
                <?= Html::a('<i class="fa fa-plus"></i> Crear Anexo', ['/litigante/pj-anexo/create','id'=> $model->id], ['class' => 'btn btn-success']) ?>
            </p>
