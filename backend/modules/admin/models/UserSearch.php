...
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username','globalSearch', 'first_name', 'last_name', 'dni', 'domicilio', 'auth_key', 'password_hash', 'password_reset_token', 'email'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->orFilterWhere(['like', 'username', $this->globalSearch])
            ...
            ->orFilterWhere(['like', 'dni', $this->globalSearch])
            ->orFilterWhere(['like', 'domicilio', $this->globalSearch])
