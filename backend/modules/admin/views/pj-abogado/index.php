...
/* @var $searchModel backend\modules\admin\models\PjAbogadoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'ABOGADOS';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pj-abogado-index">
        ...
        <div class="well">
            ...
            <div class="row">
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <p>
                        <?= Html::a('<i class="fa fa-plus-circle"></i> CREAR ABOGADO', ['create'], ['class' => 'btn btn-success']) ?>
                    </p>
